...
namespace MyFormA
{
    public partial class FormAgain : Form
    {
        ...
        static string conn_KinoDB = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:
        \Users\opilane\source\repos\finalForm3-master\MyFormA\AppData\Kino_DB.mdf;Integrated 
        Security=True";
        ...
        public void Saada_piletid(List<Pilet> piletid)
        {
            ...
            foreach (var item in piletid)
            {
                ...
                command = new SqlCommand("INSERT INTO Piletid(Rida,Koht,Film) VALUES(@rida,@koht,@film)",
                    connect_to_DB);
